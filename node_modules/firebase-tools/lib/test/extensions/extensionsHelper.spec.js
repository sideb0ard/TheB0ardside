...
describe("extensionsHelper", () => {
    ...
    describe("getValidInstanceId", () => {
        ...
        it("return extensionName if it is not used by another instance ", () => __awaiter(this, void 0, void 0, function* () {
        ...
        it("prompt the user if extensionName is already used, and return if the user provides a valid id", () => __awaiter(this, void 0, void 0, function* () {
            const extensionName = "extension-name";
